...
import {addAuthor, setAuthorAddedStatus} from '../redux/reducer';
...
function AddAuthor({navigation}: AuthorNavProps) {
  ...
  React.useEffect(() => {
    dispatch(setAuthorAddedStatus({authorAddedStatus: ''}));
  }, []);
  React.useEffect(() => {
    if (loading) {
      setTimeout(() => {
  ...
  return (
    <Box
      ...
      padding="10%">
      <ScrollView showsVerticalScrollIndicator height="100%">
        <VStack space={3}>
